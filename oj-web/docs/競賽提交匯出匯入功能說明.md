...
```html
<li>
  <a class="dropdown-item" href="{% url 'export_submissions' %}">
    <i class="fas fa-file-export" style="color: #fa709a;"></i> 競賽提交匯出
  </a>
</li>
<li>
  <a class="dropdown-item" href="{% url 'import_submissions' %}">
...
### 前端模板
**新增檔案**:
- `app_management/templates/app_management/export_submissions.html`
- `app_management/templates/app_management/import_submissions.html`
