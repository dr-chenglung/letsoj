...
urlpatterns = [
    ...
    path(
        "export_submissions/",
        views.export_submissions,
        name="export_submissions",
    ),
    # 匯入競賽提交記錄
    path(
        "import_submissions/",
        views.import_submissions,
        name="import_submissions",
    ),
    # 完整競賽匯出
    path(
        "export_contest_and_problems/",
        views.export_contest_and_problems,
        name="export_contest_and_problems",
    ),
    # 完整競賽匯入
    path(
        "import_contest_and_problems/",
        views.import_contest_and_problems,
        name="import_contest_and_problems",
    ),
]
